...
def split_data(df):
    """Split dataset in two datasets : train and test"""
...
def evaluate_model(name, model, X_test_vec, y_test):
    """Classification report and confusion matrix for every test"""
...
def plot_confusion_matrices(models, model_names, X_test_vec, y_test):
    ...
    plt.tight_layout()
    plt.savefig(f"all_confusion_matrix.png")
    plt.show()
...
def main():
    ...
    evaluate_model("Naive Bayes", best_nb, X_test_vec, y_test)
    ...
    evaluate_model("SVM ", best_svm, X_test_vec, y_test)
    ...
    evaluate_model("Random Forest", best_rf, X_test_vec, y_test)
    ...
    all_names = ["Naive Bayes", "SVM", "Random Forest"]
